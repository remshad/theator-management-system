...
<body>
<div class="center" style="background:#000066; width:1000px; height:800">
<div id="wrapper">
	<div id="header">
   
        <ul id="mainnav">
			<li><a href="index.php">Home</a></li>
            <li class="current"><a href="gallerys.php">Gallery</a></li>
    ...
    <div id="content">
    	<div id="gallerycontainer">
			<ul class="portfolio-categ filter">
				<li><H1 style="font-size:56px">UPCOMING MOVIE</H1></li>
				
			</ul>
			<ul class="portfolio-area" style="width: 900px; float:left;">	
 		
               		<li class="portfolio-item2" data-id="id-0" data-type="cat-item-4">	
			        <div>
                   <span class="image-block">
					<a class="image-zoom" href="pics/asfv.jpg" rel="prettyPhoto[gallery]" title="Shes Dating the Gangster"><img width="225" height="140" src="pics/asfv.jpg" alt="Shes Dating the Gangster" title="Shes Dating the Gangster" />                    
                    </a>
                    </span>
                   <div class="home-portfolio-text">
					<h2 class="post-title-portfolio"><a href="#" rel="bookmark" title="Shes Dating the Gangster">Shes Dating the Gangster</a></h2>
