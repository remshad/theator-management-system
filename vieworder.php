...
<!--				<div class="sub-header-right">
  ...
  ?>
          ...
          <table border="1">
              <tr><th>Name</th><th>Price</th><th>Quantity</th><th>Total Amount</th><th>Username</th><th>Theatrename</th><th>Status</th></tr>
              <?php
                include 'connection.php';
                $s="select * from buy";
                ...
                while ($s2=  mysqli_fetch_assoc($s1))
                {
                    ...
                    $status=$s2['status'];
                ?>
              <tr><td><?php echo $name;?></td><td><?php echo $price;?></td><td><?php echo $count;?></td><td><?php echo $total;?></td><td><?php echo $mail;?></td><td><?php echo $theatrename;?></td><td><?php echo $status;?></td></tr>
             <?php
                }
              ?>
          </table>
