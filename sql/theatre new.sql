...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2019 at 09:38 AM
...
CREATE TABLE `movie` (
  ...
  `mov_img_path` varchar(50) DEFAULT NULL,
...
INSERT INTO `theatre` (`t_id`, `t_theatrename`, `district_id`, `u_id`) VALUES
(1, 'NEW THEATRE', 9, 4);
...
(4, 'testmgr@mail.com', 'testmgr', '21', '1231231234', '698d51a19d8a121ce581499d7b701668', 0, 1, 1);
...
--
ALTER TABLE `movie_category`
  MODIFY `movcat_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `rating`
  MODIFY `rat_id` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `screen_details`
  MODIFY `scrd_id` int(11) NOT NULL AUTO_INCREMENT;
