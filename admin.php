...
<!--				<div class="sub-header-right">
  ...
  ?>
          ...
          <table>
              <tr><td colspan="2"><center><h1><b>ADD FILMS</b></h1></center></td></tr>
              <tr><td>FILM NAME</td><td><input type="text" name="filmname" placeholder="enter film name"></td></tr>
              <tr><td>LANGUAGE</td><td><input type="text" name="language" placeholder="enter language"></td></tr>
              <tr><td>CATEGORY</td><td><input type="text" name="category" placeholder="enter category"></td></tr>
